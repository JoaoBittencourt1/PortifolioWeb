...
/* eslint-disable react-hooks/set-state-in-effect -- upstream React Bits component; effects sync internal state to props */
...
export default function ThoughtLine({
  ...
  const latest = useRef({});
  // eslint-disable-next-line react-hooks/refs -- upstream React Bits pattern: latest callback without re-subscribing
